...
// 获取员工列表
func (es *EmployeeService) GetEmployeeList(ctx context.Context) ([]*Employee, error) {
...
// 更新员工
func (es *EmployeeService) UpdateEmployee(ctx context.Context, e *Employee) (*Employee, error) {
